...
import { Jobs, Tewokjars, Tewokjcos, Tewokjins, Tewokjsos, TewokjarsAlta } from '../clases/jobs';
...
export class FormAltaJobsComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.datos_ok) {
      ...
      this.bbddJobsService.createJob(this.jobs)
...
//    let jobsCriticidadDeepCopy: Tewokjars[] = formModel.jobsCriticidad.map(
//      (jobsCriticidad: Tewokjars) => Object.assign({}, jobsCriticidad)
//    );
...
//  valida_jobsCriticidadDeepCopy(datos: Tewokjars[]) {
//    for (let data of datos) {
//      let data_criticidad: Tewokjars = data;
//
//      if (data_criticidad.id.xti_igualdad != <string>"I" && data_criticidad.id.xti_igualdad != <string>'D') {
//        data_criticidad.id.xti_igualdad = 'N';
//      }
//    }
//    return datos;
//  }
